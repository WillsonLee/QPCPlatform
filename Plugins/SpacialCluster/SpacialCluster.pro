#-------------------------------------------------
#
# Project created by QPCPlatform 2019-09-27 21:01:57
#
#-------------------------------------------------
...
TARGET = SPACIALCLUSTER
TEMPLATE = lib

DEFINES += SPACIALCLUSTER_LIBRARY
...
SOURCES += \
    spacialcluster.cpp \
    spacialclusterwidget.cpp

HEADERS += \
    spacialcluster.h \
    spacialcluster_global.h \
    spacialclusterwidget.h
