#ifndef MATDISPLAYER_H
#define MATDISPLAYER_H

#include "matdisplayer_global.h"
#include <Any.h>
#include <iplugin.h>
#include <reflex.h>
#include <matdisplayerwidget.h>

class MATDISPLAYERSHARED_EXPORT MatDisplayer:public IPlugin
{
public:
    MatDisplayer();
...
private:
    //定义内部参数
    MatDisplayerWidget *pluginWidget;
	//反射构造器后面不要加语句,如果要加,要用public,private,protected等权限符隔开
    CONSTRUCTOR(MatDisplayer)
};
REGISTER_REFLEX(MatDisplayer)
