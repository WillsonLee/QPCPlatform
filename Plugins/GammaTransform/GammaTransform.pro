#-------------------------------------------------
#
# Project created by QPCPlatform 2019-09-26 12:19:44
#
#-------------------------------------------------
...
TARGET = GAMMATRANSFORM
TEMPLATE = lib

DEFINES += GAMMATRANSFORM_LIBRARY
...
SOURCES += \
    gammatransform.cpp \
    gammatransformwidget.cpp

HEADERS += \
    gammatransform.h \
    gammatransform_global.h \
    gammatransformwidget.h
